...
<body>
    <nav id="main-navbar">
        <div class="container">
            <ul>
                ...
                <li>
                    <a href="{{ url('directors') }}" class="nav-link">Directors</a>
                </li>
                <li>
                    <a href="{{ url('actors') }}" class="nav-link">Actors</a>
                </li>
                <li>
                    <a href="{{ url('genres') }}" class="nav-link">Genres</a>
                </li>
            </ul>
    ...
    <br><br>
    <div class="container">
        <form action="{{ route('searchforstuff') }}" method="GET">
            @csrf
            <div class="post-comment-wrapper">
                <input type="text" name="search_for" class="form-control" />

                <button class="btn btn-primary" value="Reply">Search</button>
            </div>
        </form>
    </div>
    @yield('content')
